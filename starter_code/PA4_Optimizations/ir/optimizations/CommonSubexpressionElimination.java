...
public class CommonSubexpressionElimination extends BaseOptimization {
    ...
    private void eliminateRecursive(BasicBlock block, Map<String, Variable> available) {
        ...
        for (int i = 0; i < instructions.size(); i++) {
            ...
            // Skip eliminated instructions or instructions that don't have a variable destination
            ...
            if (isPureComputation(instruction)) {
                ...
                if (local.containsKey(signature)) {
                    ...
                    logInstruction(instruction, "Eliminated: " + instruction.toString() + " -> " + replacement.toString());
                    this.changed = true;
                } else {
